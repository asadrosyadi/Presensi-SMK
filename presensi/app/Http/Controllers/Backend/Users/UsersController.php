    ...
    public function importData(Request $request)
    {
        ...
        if ($request->hasFile('import')) {
            ...
            if ($extension == 'csv') {
                ...
                if ($countheader > 0 && in_array('email', $header, true) && in_array('first_name', $header, true) && in_array('last_name', $header, true) && in_array('class', $header, true) && in_array('NIS', $header, true) && in_array('role', $header, true) && in_array('password', $header, true)) {
