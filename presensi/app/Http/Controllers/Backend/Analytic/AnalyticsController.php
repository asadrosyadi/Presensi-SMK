...
class AnalyticsController extends Controller
{
    ...
    public function index(Datatables $datatables, Request $request)
    {
        ...
        $columns = [
            ...
            'NIS' => ['NIS' => 'user.NIS'],
            'date',
            'in_time'=> ['title' => 'Clock-In'],
            'out_time'=> ['title' => 'Clock-Out'],
            //'work_hour'=> ['title' => 'Time in School'],
            'late_time',
            'over_time',
            'early_out_time',
        ...
        if ($datatables->getRequest()->ajax()) {
            return $datatables->of($getDataAnalytics)
                ...
                ->addColumn('class', function (Attendance $data) {
                    return $data->user->class;
                })
                ->addColumn('NIS', function (Attendance $data) {
                    return $data->user->NIS;
                })
