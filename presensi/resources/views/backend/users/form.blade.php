...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-sm-2 col-form-label">
                    <strong class="field-title">Class</strong>
                </div>
                <div class="col-sm-10 col-content">
                    {{ Form::text('class', $data->class, array('class' => 'form-control', 'required')) }}
                    <small class="form-text text-muted">
                        <i class="fa fa-question-circle" aria-hidden="true"></i> User class.
                    </small>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-sm-2 col-form-label">
                    <strong class="field-title">NIS</strong>
                </div>
                <div class="col-sm-10 col-content">
                    {{ Form::text('NIS', $data->NIS, array('NIS' => 'form-control', 'required')) }}
                    <small class="form-text text-muted">
                        <i class="fa fa-question-circle" aria-hidden="true"></i> User NIS.
                    </small>
                </div>
            </div>
