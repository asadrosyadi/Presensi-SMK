...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-sm-2 col-form-label">
                    <strong class="field-title">Download Template XLS</strong>
                </div>
                <div class="col-sm-10 col-content">
                    <a href="{{ asset('img/Template Upload Siswa.xlsx') }}" download=""><button type="button" class="btn btn-success"> Download Template XLS</button></a>
                </div>
            </div>

            <div class="form-group row">
                <div class="col-sm-2 col-form-label">
                    <strong class="field-title">Download Template CSV</strong>
                </div>
                <div class="col-sm-10 col-content">
                    <a href="{{ asset('img/template Upload Siswa.csv') }}" download=""><button type="button" class="btn btn-success"> Download Template CSV</button></a>
                </div>
            </div>
